            ...
            <div>
              ...
              <div>
                {nav.navs.map(({ icon, title }) => (
                  <div className="px-4 py-2 flex gap-2 border-5 border-solid border-r-white hover:border-r-[#26567E] border-t-white border-l-white border-b-white hover:bg-[#D0D6DD] cursor-pointer">
                    {icon}
                    <span>{title}</span>
                  </div>
                ))}
